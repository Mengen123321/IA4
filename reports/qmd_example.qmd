...
![Horse populations for all provinces in Canada from 1906 - 1972](docs/horse_pops_plot.png){#fig-horse-pop width=70%}
...
![Horse populations for the province with the largest standard deviation](docs/horse_pops_plot_largest_sd.png){#fig-largest-sd width=65%}
