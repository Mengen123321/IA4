...
![Horse populations for all provinces in Canada from 1906 - 1972](horse_pops_plot.png){#fig-horse-pop width=70%}
...
![Horse populations for the province with the largest standard deviation](horse_pops_plot_largest_sd.png){#fig-largest-sd width=65%}
